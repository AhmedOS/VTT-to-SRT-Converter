...
namespace VttSrtConverter.Core
{
    ...
    {
        public static string invalidFile = "Invalid file: Found timecode without caption";
        public static string invalidTimeFormat = "Invalid file: Time format is not compatible";
